...
const STN = ({mostrarProgramas, programa: { programas, loadingProgramas}}) => {
    ...
    if(programas?.length > 0){
        ...
        for (let index = 0; index < programas.length; index++) {
            if(programas[index]?.tipo == "live"){
                arrayTemporal.push(programas[index])
            }
            setArrayProgramas(arrayTemporal)
  ...
  return (
    <Container>
      <Portada
        titulo={"Streamings"}
        subtitulo={
          "Todos nuestros streamings nutricionales"
        }
      />
        ...
        <section id="team" className="team section">
          ...
          <div className="container section-title" data-aos="fade-up">
            <h2>S.A.F</h2>
            <div>
              <span>Todas</span> <span className="description-title">Los STREAMINGS</span>
            </div>
          </div>
